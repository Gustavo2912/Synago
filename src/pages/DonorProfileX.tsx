...
export default function DonorProfile({ donor, open, onClose }: DonorProfileProps) {
  ...
  const pledgeTotalsPerCurrency = useMemo(() => {
    ...
    pledges.forEach((p: any) => {
      ...
      const paid = payments.reduce((s: number, x: any) => s + Number(x.amount), 0);
        ...
        <DialogContent className="max-w-6xl max-h-[90vh] overflow-y-auto">
          ...
          <div className="space-y-6 pt-2 text-sm">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4">
              ...
              {/* DONOR DETAILS */}
              <Card>
                <CardHeader><CardTitle>{t("donorProfile.details")}</CardTitle></CardHeader>
            ...
            {/* =======================================
                DONATIONS BY ORG (WITH CURRENCY)
            ======================================= */}
            <Card>
              <CardHeader>
              ...
              <CardContent className="space-y-4">
                {Array.from(donationsByOrg.entries()).map(([orgId, list]) => {
                  ...
                  const orgLabel =
                    ...
                    (list[0]?.organization_name ?? orgId);
            ...
            <Card>
              ...
              <CardContent className="space-y-3">
                {pledges.map((p: any) => {
                  ...
                  const orgLabel =
                    orgNameMap.get(p.organization_id) ||
                    p.organization_name;
