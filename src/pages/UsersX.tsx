...
import { usePendingInvitesSummary } from "@/hooks/usePendingInvitesSummary";
...
export default function Users() {
  ...
  const {
    data: pendingInvitesSummary,
    isLoading: pendingInvitesLoading,
  } = usePendingInvitesSummary(
    organizationId,
    canManageUsers // רק מי שמנהל משתמשים
  );
        ...
        <Card className="bg-white/80 backdrop-blur shadow-sm border">
          <CardHeader className="flex flex-row items-center justify-between">
            ...
            <Button
              ...
              disabled={!pendingInvitesSummary?.total}
            >
              Manage
            </Button>
          </CardHeader>
          ...
          <CardContent className="space-y-2">
            {pendingInvitesLoading ? (
              ...
              pendingInvitesSummary.total > 0 ? (
              <>
                <div className="text-3xl font-bold text-amber-600">
                  {pendingInvitesSummary.total}
                </div>

                <div className="space-y-1 text-xs text-muted-foreground">
                  {pendingInvitesSummary.byOrganization.map((o) => (
                    <div
