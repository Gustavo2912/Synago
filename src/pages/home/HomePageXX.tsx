...
export default function HomePage() {
  ...
  /* ----------------------------------------------------------
     HEADER ACTIONS
  ---------------------------------------------------------- */
  const showEditor = canEdit && hasOrgPage;
  const showEditorPane = showEditor && (mode === "edit" || mode === "split");
  const showPreviewPane = mode === "preview" || mode === "split";
    ...
    <div className="p-6 space-y-6">
      ...
      <div className="flex justify-between items-center">
        <h1 className="text-xl font-semibold">
          Home Page {isGlobalMode && "(Global)"}
        </h1>

        <div className="flex gap-2 items-center">
          {/* MODE SWITCH (ONLY IF EDITABLE) */}
          {showEditor && (
      ...
      {/* ---------- NO ORG PAGE BANNER ---------- */}
      {!hasOrgPage && previewSource === "global" && (
        <div className="rounded-lg border border-amber-300 bg-amber-50 p-4 text-sm">
          <div className="font-semibold mb-1">
            No Home Page defined for this organization
          </div>
          <div className="text-muted-foreground mb-3">
            You are viewing the <b>Global default template</b>.
            <br />
